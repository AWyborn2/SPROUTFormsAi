...
ALTER TABLE "invites" ADD COLUMN "invitee_name" text DEFAULT '' NOT NULL;--> statement-breakpoint
ALTER TABLE "assessment_part_attempts" ADD COLUMN "submitted_at" timestamp with time zone;--> statement-breakpoint
